...
exports.creds = {
  ...
  // feature.
  identityMetadata: 'https://login.microsoftonline.com/my_b2c_app.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'

  // Required, the client ID of your app in AAD  
  clientID: '6af758ca-48dd-47ea-80f6-1fe20aa28523',
  ...
  clientSecret: 'H{50$pb+k4d75T0KZXA$9GFn', 
